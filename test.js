...
request(
  {
    ...
    json: true,
    headers: {
      cookie: "PHPSESSID=omqnibihdboiu116mudkstbph4",
      client: "4",
      version: "6946.2",
      device: "OPPO R11",
      sdk: "22,5.1.1",
      ...
      "User-Agent":
        "Mozilla/5.0 (Linux; Android 5.1.1; OPPO R11 Build/NMF26X; wv) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 Chrome/74.0.3729.136 Mobile Safari/537.36",
